...
if __name__ == '__main__' :
    ...
    plt.plot(fpr_inte_lung, tpr_inte_lung, color='darkorange', lw=lw,
             label='inte_{} (AUC = %0.3f)'.format(sick_name) % roc_auc_inte_lung)
    ...
    plt.plot(fpr, tpr, color='darkorchid', lw=lw, label='CF_{} (AUC = %0.3f)'.format(sick_name) % roc_auc)
    # #
