...
if __name__ == '__main__':
    ...
    for fold in range(1,2):
        ...
        NLP_hidden_train_df = pd.read_excel('./data/Integration_data/NLP_hidden_CF_train_ending_multi-{}.xlsx'.format(str(fold)),index_col=0).drop_duplicates(subset=['patient_id'])
